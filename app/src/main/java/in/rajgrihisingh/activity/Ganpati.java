...
import in.rajgrihisingh.fragment.Boring;
...
public class Ganpati extends AppCompatActivity {
    ...
    private static final String TAG_REPORT = "Boring";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityTitles = getResources().getStringArray(R.array.nav_item_activity_titles2);
    ...
    private Fragment getHomeFragment() {
        switch (navItemIndex) {
            ...
            case 11:
                ...
                Intent intent=new Intent(Ganpati.this,Login.class);
                        ...
                        try {
                            ...
                            if (obj.getBoolean("status")) {
                                ...
                                if (version_name.equals(versionName)) {
                                    ...
                                    updateMeeDialog.showDialogAddRoute(Ganpati.this, PACKAGE_NAME);
                                }
                            }
