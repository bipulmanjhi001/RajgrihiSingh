...
public class Expenses extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.expense_tablayout, container, false);

        viewPagers = (ViewPager) rootView.findViewById(R.id.expenseview);
        tabLayouts = (TabLayout) rootView.findViewById(R.id.expensetab);
        adapters = new TabAdapter(getActivity().getSupportFragmentManager());

        adapters.addFragment(new ExpensesDetails(), "Add expenses");
        adapters.addFragment(new ViewExpenses(), "View expenses");
